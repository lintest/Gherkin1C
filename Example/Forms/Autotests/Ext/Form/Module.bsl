...
Процедура Тест_ПарсингПримитивногоСценария(Ожидается) Экспорт
	...
	Ожидается.Тест("Параметр число").Что(СписокШагов).Получить(13, "tokens", 2, "text").Равно("""1""");
...
Процедура Тест_СтруктураСценария(Ожидается) Экспорт
	...
	Ожидается.Тест("Первый пример, первый шаг").Что(ТаблицаПримеров).Получить("body", 0, "script", "steps", 0, "text").Равно("Когда у меня есть ""Книга""");
	Ожидается.Тест("Первый пример, второй шаг").Что(ТаблицаПримеров).Получить("body", 0, "script", "steps", 1, "text").Равно("Тогда я могу ""Читать""");
	Ожидается.Тест("Второй пример, первый шаг").Что(ТаблицаПримеров).Получить("body", 1, "script", "steps", 0, "text").Равно("Когда у меня есть ""Ручка""");
	Ожидается.Тест("Второй пример, второй шаг").Что(ТаблицаПримеров).Получить("body", 1, "script", "steps", 1, "text").Равно("Тогда я могу ""Писать""");
	...
	Ожидается.Тест("Первый шаг первой строки").Что(ТаблицаПримеров).Получить(0, "script", "steps", 0, "text").Равно("Когда у меня есть ""Окно""");
	Ожидается.Тест("Второй шаг первой строки").Что(ТаблицаПримеров).Получить(0, "script", "steps", 1, "text").Равно("Тогда я могу ""Открыть""");
	Ожидается.Тест("Первый шаг второй строки").Что(ТаблицаПримеров).Получить(1, "script", "steps", 0, "text").Равно("Когда у меня есть ""Дверь""");
	Ожидается.Тест("Второй шаг второй строки").Что(ТаблицаПримеров).Получить(1, "script", "steps", 1, "text").Равно("Тогда я могу ""Закрыть""");
	...
	Ожидается.Тест("Первый шаг первой строки").Что(ТаблицаПримеров).Получить(0, "script", "steps", 0, "text").Равно("Когда Я передал первый параметр сложения 14");
	Ожидается.Тест("Второй шаг первой строки").Что(ТаблицаПримеров).Получить(0, "script", "steps", 1, "text").Равно("И Я передал второй параметр сложения 7");
	Ожидается.Тест("Третий шаг второй строки").Что(ТаблицаПримеров).Получить(0, "script", "steps", 2, "text").Равно("Тогда Я получу Сумму 21");
	Ожидается.Тест("Первый шаг второй строки").Что(ТаблицаПримеров).Получить(1, "script", "steps", 0, "text").Равно("Когда Я передал первый параметр сложения 13");
	Ожидается.Тест("Второй шаг второй строки").Что(ТаблицаПримеров).Получить(1, "script", "steps", 1, "text").Равно("И Я передал второй параметр сложения 12");
	Ожидается.Тест("Третий шаг первой строки").Что(ТаблицаПримеров).Получить(1, "script", "steps", 2, "text").Равно("Тогда Я получу Сумму 25");
