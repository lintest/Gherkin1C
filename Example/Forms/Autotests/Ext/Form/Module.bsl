...
Процедура Тест_СекцияПеременные(Ожидается) Экспорт
	...
	Ожидается.Тест("Импорт файла 1").Что(ДанныеФайла).Получить("variables", "import", 0, "name").Равно("ФайлИмпорта.feature");
	Ожидается.Тест("Импорт файла 2").Что(ДанныеФайла).Получить("variables", "import", 1, "name").Равно("Импорт.feature");
	...
	Ожидается.Тест("Имя файла").Что(ДанныеФайла).Получить("variables", "import", 0, "name").Равно(ИмяФайла);
	...
	Ожидается.Тест("Файлы переменных").Что(ДанныеФайла).Функц("Количество").Равно(2);
	Ожидается.Тест("Очищаем кэш одного файла").Что(ВК).Проц("ОчиститьКэш", ОсновнойФайл).Функц("ПолучитьПеременные").JSON().Функц("Количество").Равно(1);
