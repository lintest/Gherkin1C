...
Процедура Тест_СтруктураСценария(Ожидается) Экспорт
	...
	Ожидается.Тест("Передача первой таблицы в примеры").Что(ШагиСценария).Получить(0, "snippet", "examples", "body", 0).Получить("tokens", 0, "text").Равно("""Окно""");
	Ожидается.Тест("Передача второй таблицы в примеры").Что(ШагиСценария).Получить(1, "snippet", "examples", "body", 0).Получить("tokens", 0, "text").Равно("14");
