...
Процедура ЗаполнитьНаборТестов(ЮнитТест, Интерактивно = Ложь) Экспорт
	...
	ЮнитТест.Добавить("Тест_ПередачаТаблиц", "Передача таблиц");
...
&НаКлиенте
Процедура Тест_ПередачаТаблиц(Ожидается) Экспорт
	...
	Ожидается.Тест("Вторая таблица").Что(ШагиПодсценария).Получить(2, "tables", 0, "body", 2, 1, "text").Равно("35");
	Ожидается.Тест("Третья таблица").Что(ШагиПодсценария).Получить(4, "tables", 0, "body", 2, 1, "text").Равно("10");
